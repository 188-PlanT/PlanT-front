...
const AddTeamSchedule: NextPageWithLayout<AddTeamScheduleProps> = ({}) => {
...
export default AddTeamSchedule;

AddTeamSchedule.getLayout = page => <CommonLayout title='PLAN,T | 팀 일정 추가'>{page}</CommonLayout>;
